...
Mais pour nous, cette extension (Complétée d'une autre et de réglages) va nous permettre de gagner énormément en efficience !
...
Notre système **S**hortcut + **B**etter **C**omment + **T**o**D**o est la **Solution Optimal**e !
...
Donc, tu dois voir que ce tableau est plutôt long, très long... (Il faut préciser que sont référencées là aussi tous les raccourcis des extensions installées...)
